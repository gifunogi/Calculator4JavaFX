...
public class Parser implements ParserConstants {
  ...
  final private Node num() throws ParseException {
    ...
    case NUM:
      token = jj_consume_token(NUM);
                    {if (true) return new Num(new BigDecimal(token.image));}
      break;
    case MINUSSIGN:
      jj_consume_token(MINUSSIGN);
      token = jj_consume_token(NUM);
                                  {if (true) return new Num(new BigDecimal(token.image).negate());}
      break;
    default:
      jj_la1[5] = jj_gen;
      jj_consume_token(-1);
  ...
  static {
   ...
   private static void jj_la1_init_0() {
      jj_la1_0 = new int[] {0x30,0x30,0xc0,0xc0,0x2900,0x2800,};
   }
